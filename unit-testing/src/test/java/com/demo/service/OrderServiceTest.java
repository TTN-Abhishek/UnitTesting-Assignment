...
public class OrderServiceTest {
   ...
   public void test_placeORderVoidType(){
       ...
       //When
       Mockito.when(order.getPrice()).thenReturn(80.020/100);
       Mockito.when(order2.setPriceWithTax(80.020/100)).thenReturn(new Order());
   ...
   public void test_placeOrderBooleanReturnType(){
       Mockito.when(email.sendEmail(order, "Abhishek Kumar")).thenReturn(true);
       assertTrue(email.sendEmail(order,"Abhishek Kumar"));
   }
}